...
static void
secp224r1_key_exchange(const u8 *public, const u8 *secret, u8 *shared)
{
	ecdh_shared_secret(public, secret, shared);
}

static void
secp224r1_key_pair(u8 *public_key, u8 *private_key)
{
}

static void
secp224r1_derive(const u8* seed, const u8 *public, u8 *shared)
{
}

struct ecc_group secp224r1_ecc_group = {
	.name = "secp224r1",
	.id = ECC_GROUP_SECP224R1,
	.pub_key_len = ECC_BYTES,
	.prv_key_len = ECC_BYTES,
	.key_pair = secp224r1_key_pair,
	.key_exchange = secp224r1_key_exchange,
	.size = 28,
	.derive = secp224r1_derive,
};

void ecc_secp224r1_init(void)
{
	crypto_ecc_group_register(&secp224r1_ecc_group);
}
